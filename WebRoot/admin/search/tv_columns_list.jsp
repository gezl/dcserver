...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="sdb?opr=userConfigService&ac=getColumnsList" method="post" name="tvColumonFrom" id="tvColumonFrom">
			<table>
				<tr>
					<td>
						...
						<c:forEach items="${sEntityList}" var="item" varStatus="vs">
							<tr>
								<td class='center' style="width: 30px;">
									<label><input type="checkbox" name="columnname" id="columnname"  value="${item.columns.column_name }"/><span class="lbl"></span></label>
								</a>
								</td>
		...
		<table style="width:100%;">
			...
			<td style="vertical-align:top;">
					<a class="btn btn-mini btn-danger" onclick="searchBack()">确定</a>
				</td>
				<td style="vertical-align:top;">
