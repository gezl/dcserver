...
<link href="<%=path %>/static/login/font-awesome.css" rel="stylesheet" />
<script type="text/javascript" src="<%=path %>/static/js/jquery-1.5.1.min.js"></script>

<link rel="stylesheet" href="<%=path %>/static/login/bootstrap.min.css" type="text/css"></link></head>
<body>
	...
	<div
		...
		<div id="loginbox">
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						<span class="pull-right" style="padding-right:3%;"><a
							...
							class="pull-right">
							<a onclick="severCheck();" class="flip-link btn btn-info" id="to-recover">登录</a></span>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white">
						<span id="nameerr">Copyright © cfdport 2017</span>
					</font>
				</div>
			</div>
		</div>
				...
				$.ajax({
					...
					success: function(data){
						if("success" == data.result){
							saveCookie();
							window.location.href="<%=path%>/sdb?opr=cfdLoginService&ac=login4Index";
